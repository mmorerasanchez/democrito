...
function SoloDeveloperPage() {
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        <Badge variant="outline" className="font-mono text-xs">Persona 1</Badge>
        <Heading level="h1">Solo developer building an AI tool</Heading>
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <Heading level="h1">Two-person startup building a developer dashboard</Heading>
...
function GrowthEngineerPage() {
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        <Badge variant="outline" className="font-mono text-xs">Persona 3</Badge>
        <Heading level="h1">Growth engineer building an internal AI ops platform</Heading>
...
// ---------------------------------------------------------------------------
// Router — maps slug → persona page
// ---------------------------------------------------------------------------

const personaMap: Record<string, React.ComponentType> = {
  "solo-developer": SoloDeveloperPage,
  "startup": StartupPage,
  "growth-engineer": GrowthEngineerPage,
};
...
export default function UseCaseDetailPage() {
  ...
  const PersonaContent = personaMap[persona];
